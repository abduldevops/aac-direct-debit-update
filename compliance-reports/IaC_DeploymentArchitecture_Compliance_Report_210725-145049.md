...
2. **[Resource Alignment]:**
   - Align the Terraform resources with the architecture diagram by ensuring that the aws_cloudwatch_metric_alarm and aws_cloudwatch_log_group are represented in the diagram or justified in the code as necessary for observability.
---
...
1. **Define IAM Permissions for Secrets Access:**
   ...
   - Add IAM policy in Terraform to grant necessary permissions.
